...
a = [131,  98, 125, 131, 124, 139, 131, 117, 128, 108, 135, 138, 131, 102, 107, 114, 119, 128, 121, 142, 127, 130, 124,
     ...
     103, 130, 141, 117, 106, 114, 121, 114, 133, 137, 92, 121, 112, 146,  97, 137, 105, 98, 117, 112,  81, 97, 139,
     113, 134, 106, 144, 110, 137, 137, 111, 104, 117, 100, 111, 101, 110, 105, 129, 137, 112, 120, 113, 133, 112, 83,
     94, 146, 133, 101, 131, 116, 111,  84, 137, 115, 122, 106, 144, 109, 123, 116, 111, 111, 133, 150]

# 设置组距
bin_width = 3
# 求解组数，如果极差正好呗组距整除，那么会避免错位的情况
...
# 设置x轴刻度，最大值加上一个组距可以保证最后一个刻度显示出来
...
# 修改坐标轴和抬头
plt.xlabel("电影时长（分钟）", fontproperties=font_label)
plt.ylabel("数量（部）", fontproperties=font_label)
plt.title("2017年250部电影的时长分布情况", fontproperties=font_title)
# 网格
plt.grid(alpha=1)
plt.show()
